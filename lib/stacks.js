...
export const stack = [
  ...
  {
    name: "Java",
    icon: <img src="/java.png" alt="Java" className="w-full h-full" />,
    color: "#007396",
  },
  {
    name: "Bun",
    icon: <img src="/bun.png" alt="Bun" className="w-full h-full" />,
    color: "#000000",
  },
  ...
  {
    name: "shadcn/ui",
    icon: <img src="/shadcn.png" alt="shadcn/ui" className="w-full h-full" />,
    color: "#000000",
  },
  { name: "Framer Motion", icon: <SiFramer />, color: "#0055FF" },
  {
    name: "TanStack Query",
    icon: (
      <img src="/tanstack.png" alt="TanStack Query" className="w-full h-full" />
    ),
    color: "#FF4154",
  },
  {
    ...
    icon: (
      ...
      >
        <rect
          ...
          height="256"
          rx="128"
          fill="url(#paint0_linear_magic)"
        />
        <rect
          width="256"
          height="256"
          rx="128"
          fill="url(#paint1_linear_magic)"
        />
        <path
        ...
        <defs>
          ...
          >
            ...
            <stop offset="0.333333" stop-color="#FE8BBB" />
            <stop offset="0.666667" stop-color="#FFBD7A" />
  ...
  },
  {
    name: "Antigravity",
    icon: (
      <img src="/antigravity.png" alt="Antigravity" className="w-full h-full" />
    ),
    color: "#000000",
  },
  { name: "LangChain", icon: <SiLangchain />, color: "#1C3C3C" },
  {
    ...
    icon: (
      ...
      >
        ...
        <path d="M10 7.5L6.5 15.5" stroke="currentColor" strokeWidth="2" />
        <path d="M14 7.5L17.5 15.5" stroke="currentColor" strokeWidth="2" />
  ...
  { name: "Postman", icon: <SiPostman />, color: "#FF6C37" },
  {
    name: "Zustand",
    icon: (
      <img src="/zustand.png" alt="Zustand" className="w-full h-full object-contain" />
    ),
    color: "#443222",
  },
  {
    name: "OpenRouter",
    icon: (
      <img src="/openrouter.png" alt="OpenRouter" className="w-full h-full object-contain dark:invert" />
    ),
    color: "#6467F2",
  },
  {
    name: "Google Colab",
    icon: (
      <img src="/colab-color.png" alt="Google Colab" className="w-full h-full object-contain" />
    ),
    color: "#F9AB00",
  },
];
